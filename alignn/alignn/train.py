...
def train_dgl(
    ...
    _model = {"cgcnn": CGCNN, "icgcnn": iCGCNN, "densegcn": DenseGCN, "alignn": ALIGNN,
              "alignn_atomwise": ALIGNNAtomWise, "dense_alignn": DenseALIGNN, "alignn_cgcnn": ACGCNN,
    ...
    if config.model.name == "alignn_atomwise":
        ...
        def get_batch_errors(dat=[]):
            ...
            mean_out, mean_atom, mean_grad, mean_stress = 0, 0, 0, 0
